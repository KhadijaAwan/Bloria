...
export default function Hero() {
    return (
        <section className="w-[100%] mt-5 md:mt-8 lg:mt-16">
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-center my-10 px-0 md:px-4">
                ...
                <div className="flex flex-col lg:p-3">
                    ...
                    <Link href="/compose" aria-label="compose button" className={`${linkStyle} text-sm mb-3 w-max mx-auto mt-5 lg:mx-0 bg-purple-800 hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-900 text-white rounded-md px-5 py-2`}>Post Now</Link>
                </div>
            </div>
        </section>
    );
